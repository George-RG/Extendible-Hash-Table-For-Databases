# Extendible Hash Table For Databases
...
- __*src/main.c*__ : The main function that we have created is used to test all the functions that we have implemented. It creates multiple databases and tests all the possible functions. Many of the test setting are confgurable at the top of the src/main.c file.
